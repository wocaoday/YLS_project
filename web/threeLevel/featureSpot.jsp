      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;末端是千姿百态的冰塔林,因阳光折射呈现出蓝绿色,人称“绿雪奇峰”。游客须乘坐索道方能到达冰川公园,欣赏这一奇景。
                       ...
                       <div class="picture">
                          ...
                          <div class="picture-li">
                            ...
                            <a href="javaScript:Scroll('Direction',1)" class="pictureLeft"><img src="../images/ico-15.png"/></a>
                            <div class="picture-text" id="smallImg">
                              
                              <div class="picture-imgbox">
                                 <ul>
                                    <li id="smallSpace">
                                        <a href="javascript:"><img src="../images/img-24.jpg" onclick="changeBigImg(this)"/></a>
                                        <a href="javascript:"><img src="../images/img-24.jpg" onclick="changeBigImg(this)"/></a>
                                        <a href="javascript:"><img src="../images/img-24.jpg" onclick="changeBigImg(this)"/></a>
                                        <a href="javascript:"><img src="../images/img-24.jpg" onclick="changeBigImg(this)"/></a>
                                        <a href="javascript:"><img src="../images/img-24.jpg" onclick="changeBigImg(this)"/></a>
                            ...
                            <a href="javaScript:Scroll('Direction',-1)" class="pictureRight"><img src="../images/ico-16.png"/></a>
                       ...
                       <div class="spot-ticket">
                         ...
                         <div class="spot-table"><img src="../images/img-30.jpg"/></div>
                         <!--
                           <table cellpadding="0" cellspacing="1" border="0" class="spot-table">
                            <thead>
                             <tr>
                                <th width="20%">门票类型</th>
                                <th width="15%">窗口价格</th>
                            ...
                            <tbody>
                              <tr>
                                <td width="20%" height="23">24个项目套票</td>
                                <td width="15%">70元</td>
                                <td width="15%">50元</td>
                                <td>门票类型门票类型门票类型门票类型门票类型</td>
                             </tr>
                             <tr>
                                <td width="20%" height="23">24个项目套票</td>
                                <td width="15%">70元</td>
                             ...
                             <tr>
                                <td width="100%" colspan="4" height="23">24个项目套票门票类型门票类型门票类型门票类型门票类型</td>
                             </tr>
                             <tr>
                                <td width="100%" colspan="4" height="50">24个项目套票门票类型门票类型门票类型门票类型门票类型</td>
                             </tr>
                            </tbody>
                           </table>
                           -->
                           <div class="spot-tic">
                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;全日制本科及以下学历的学生；未满十八周岁的未成年人；军队退休干部，凭有效身份证明及相关证件半价购买景区门票。<br/>
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2 、门票说明： 门票包含玉龙雪山、玉水寨、东巴谷、玉峰寺、玉柱擎天、白沙壁画、东巴王国、东巴万神园 8 个景区单点门票合计315元/张，不给予优惠。
                           </div>
                           
                           <div class="spot-btn"><a href="featureSpot"><img src="../images/img-04.png"></a></div>
